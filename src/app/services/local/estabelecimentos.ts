...
export const ESTABELECIMENTOS: Estabelecimento[] = [
  ...
  {
    nome: 'Léa Marie Duvivier Curdoglo',
    end: ' Clínica Volare, ao lado do Salvador Shopping, no edifício CEO Empresarial. Av Tancredo Neves 2539, Sala 2509, Salvador, BA, Brasil',
    tel: '(71) 988322327',
    whatsapp: '(71) 988322327',
    valor: 'Atendimento por planos de saúde',
    servicos: [SERVICO.CRIANCAS_E_ADOLESCENTES, SERVICO.PLANO, SERVICO.INDIVIDUAL],
    descricao_servicos: 'Terapia comportamental para jovens, adultos e idosos.',
    email: 'leamdc@gmail.com',
    mapa:
      '<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3887.881059364436!2d-38.454540185177905!3d-12.979458490850709!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x7161b049c14de4b%3A0x86848acbeee11666!2sAv.+Tancredo+Neves%2C+2539+-+Caminho+das+%C3%81rvores%2C+Salvador+-+BA%2C+41820-021!5e0!3m2!1spt-BR!2sbr!4v1540975470761" width="100%" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>',
    crp: '03/3787'
  },
  {
  ...
  },
  {
    ...
    tel: '3283-7180/ 7181',
    valor: 'Gratuito',
    servicos: [SERVICO.INDIVIDUAL, SERVICO.GRUPO, SERVICO.DROGAS],
    descricao_servicos:
  ...
  },
  {
    ...
    tel: '3202-2750',
    valor: 'Gratuito',
    servicos: [SERVICO.INDIVIDUAL, SERVICO.LGBT],
    descricao_servicos:
...

  {
    ...
    valor: 'Gratuito',
    servicos: [SERVICO.INDIVIDUAL, SERVICO.FAMILIAR, SERVICO.GRUPO],
    descricao_servicos:
...

  {
    ...
    valor: 'Gratuito',
    servicos: [SERVICO.FAMILIAR, SERVICO.PROFISSIONAL],
    descricao_servicos:
...

  {
    ...
    tel: '3205-1745',
    valor: 'Gratuito',
    servicos: [SERVICO.INDIVIDUAL, SERVICO.PROFISSIONAL, SERVICO.LGBT],
    descricao_servicos:
...

  {
    ...
    tel: '3206-8015',
    valor: 'Gratuito',
    servicos: [SERVICO.INDIVIDUAL, SERVICO.GRUPO, SERVICO.PROFISSIONAL],
    descricao_servicos:
      'Psicoterapia individual a todas as faixas etárias, Psicodiagnóstico, Avaliação Psiconeurológica, Orientação Profissional e Grupos terapêuticos.',
    mapa:
  ...
  },
  {
    ...
    tel: '3238-2847',
    valor: 'Gratuito',
    servicos: [SERVICO.CAPS, SERVICO.DROGAS],
  ...
  // Evandro
  {
    ...
    valor: 'Valor social (valor acessível)',
    servicos: [SERVICO.ONLINE, SERVICO.INDIVIDUAL],
    descricao_servicos:
